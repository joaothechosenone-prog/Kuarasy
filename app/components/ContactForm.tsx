...
export function ContactForm() {
  ...
  return (
    <form className="contact-form" onSubmit={submit}>
      ...
      <label>Assunto<select name="assunto"><option>Reserva</option><option>Restaurante</option><option>Beach Club</option><option>Evento</option><option>Outro</option></select></label>
