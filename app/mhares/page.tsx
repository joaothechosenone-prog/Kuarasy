...
export default function MharesPage() {
  return <main><Motion />
    <PageHero eyebrow="Mhares Restaurante" title="A cozinha nordestina em sua forma mais contemporânea" subtitle="Sabores autênticos, ingredientes frescos e uma vista que transforma cada refeição." image="/media/restaurant.jpeg" video="/media/hero-mhares.webm" shade />
    ...
    <section className="wide-story wide-story--video">
      <video autoPlay muted loop playsInline preload="metadata"><source src="/media/mhares-experiencia.webm" type="video/webm" /></video><div className="wide-story-shade" />
